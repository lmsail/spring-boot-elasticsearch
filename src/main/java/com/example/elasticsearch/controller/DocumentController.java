...
import com.example.elasticsearch.common.response.CommonResult;
...
public class DocumentController {
    ...
    public CommonResult<UserAccountDocument> queryDocument(@RequestParam String id) throws Exception {
        UserAccountDocument userDocument = documentService.queryDocument(id);
        return CommonResult.success(userDocument);
    }
     ...
     */
     ...
     public List<UserAccountDocument> queryAllDocument() throws Exception {
     ...
     */
    @GetMapping("/queryAll")
    public Map<String,  List<UserAccountDocument>> queryAll() throws Exception {
