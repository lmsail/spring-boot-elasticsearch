...
public interface DocumentService {
     ...
     * @throws IOException
     */
    UserAccountDocument queryDocument(String id) throws IOException;
     ...
     * @throws IOException
     */
    List<UserAccountDocument> queryAllDocument() throws IOException;
     ...
     * @throws IOException
     */
    Map<String, List<UserAccountDocument>> queryAll() throws IOException;
